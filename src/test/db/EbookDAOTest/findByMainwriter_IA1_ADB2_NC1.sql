...
INSERT INTO EBook(id, title, price, description, inCatalog, ebookFile, proposalId_fk, mainAuthorId_fk) VALUES (2, 'amica geniale', 10, 'fiction rai', false, 'file.pdf', 2, 1);
